...
class QUBO {
    private:
        ...
        std::vector<std::pair<int, ftype>> affectedby_flat; // list of js that are affected by flipping a certain bit
        std::vector<int> offset; // offset of each row in the flat list
    ...
    public:
        ...
        const std::vector<std::pair<int, ftype>>& getAffectedByFlat() const;
